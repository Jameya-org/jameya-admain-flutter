  ...
  ApiService() : _dio = Dio(BaseOptions(
    ...
    _dio.interceptors.add(InterceptorsWrapper(
      onRequest: (options, handler) {
        ...
        const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJjOGY5MzJhZS03NTg5LTQxYjItYjljZi1kOGU2ZmU3YzFiMTgiLCJlbWFpbCI6ImFkbWluQGphbWV5YS5sb2NhbCIsInJvbGUiOiJTVVBFUl9BRE1JTiIsInR5cGUiOiJhZG1pbiIsImlhdCI6MTc4NTY0Mjg4MSwiZXhwIjoxNzg1NjQzNzgxfQ.BO9XLSvG_AuSrsTzpqJFfjpMiprNjc3cFVgegmd_Iko';
